...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rol.cache'
        db.alter_column(u'trabajo_rol', 'cache', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Rol.cache'
        db.alter_column(u'trabajo_rol', 'cache', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=15, decimal_places=4))
    ...
    models = {
        u'agencia.agenciado': {
            ...
            'fecha_ingreso': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 3, 0, 0)'}),
        ...
        u'trabajo.eventorol': {
            ...
            'direccion': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'estado': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cities_light.Region']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 3, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pais': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cities_light.Country']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
        ...
        u'trabajo.itemportfolio': {
            ...
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 3, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'trabajo.postulacion': {
            ...
            'estado': ('django.db.models.fields.CharField', [], {'default': "'PC'", 'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rol': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['trabajo.Rol']", 'on_delete': 'models.PROTECT'})
        },
        ...
        u'trabajo.rol': {
            ...
            'cache': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '15', 'decimal_places': '2', 'blank': 'True'}),
