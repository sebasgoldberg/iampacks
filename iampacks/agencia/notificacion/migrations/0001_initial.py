...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NotificacionCuentaAgenciadoExistente'
        db.create_table(u'notificacion_notificacioncuentaagenciadoexistente', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email_destinatario', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True)),
            ('fecha_envio', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 4, 19, 0, 0))),
            ('agenciado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencia.Agenciado'])),
        ))
        db.send_create_signal(u'notificacion', ['NotificacionCuentaAgenciadoExistente'])


    def backwards(self, orm):
        # Deleting model 'NotificacionCuentaAgenciadoExistente'
        db.delete_table(u'notificacion_notificacioncuentaagenciadoexistente')
    ...
    models = {
        u'agencia.agenciado': {
            ...
            'fecha_ingreso': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 19, 0, 0)'}),
        ...
        u'notificacion.notificacioncuentaagenciadoexistente': {
            ...
            'fecha_envio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 19, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'perfil.danza': {
