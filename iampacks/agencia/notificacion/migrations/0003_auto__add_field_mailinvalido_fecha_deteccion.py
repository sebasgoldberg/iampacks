...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MailInvalido.fecha_deteccion'
        db.add_column(u'notificacion_mailinvalido', 'fecha_deteccion',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 19, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MailInvalido.fecha_deteccion'
        db.delete_column(u'notificacion_mailinvalido', 'fecha_deteccion')
    ...
    models = {
        ...
        u'notificacion.mailinvalido': {
            ...
            'fecha_deteccion': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 19, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
