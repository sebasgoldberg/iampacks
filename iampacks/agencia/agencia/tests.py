...
class AgenciaTestCase(TestCase):
  ...
  def get_dict_form_agenciado(mail=u'test@gmail.com',rg=u'123100',cpf=u'123100'):
    return {
      ...
      'direccionagenciado_set-0-estado' : Region.objects.get_or_create(country=Country.objects.get())[0].id,
      'direccionagenciado_set-0-ciudad' : Ciudad.objects.get_or_create(country=Country.objects.get(),region=Region.objects.get())[0].id,
