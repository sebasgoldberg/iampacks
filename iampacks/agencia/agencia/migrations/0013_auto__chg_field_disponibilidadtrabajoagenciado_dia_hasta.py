...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DisponibilidadTrabajoAgenciado.dia_hasta'
        db.alter_column(u'agencia_disponibilidadtrabajoagenciado', 'dia_hasta', self.gf('django.db.models.fields.IntegerField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'DisponibilidadTrabajoAgenciado.dia_hasta'
        db.alter_column(u'agencia_disponibilidadtrabajoagenciado', 'dia_hasta', self.gf('django.db.models.fields.CharField')(max_length=2))
