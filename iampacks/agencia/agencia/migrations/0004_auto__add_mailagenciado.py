...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailAgenciado'
        db.create_table(u'agencia_mailagenciado', (
        ...
        db.send_create_signal(u'agencia', ['MailAgenciado'])


    def backwards(self, orm):
        # Deleting model 'MailAgenciado'
        db.delete_table(u'agencia_mailagenciado')
    ...
    models = {
        ...
        u'agencia.agenciado': {
            ...
            'fecha_ingreso': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 23, 0, 0)'}),
