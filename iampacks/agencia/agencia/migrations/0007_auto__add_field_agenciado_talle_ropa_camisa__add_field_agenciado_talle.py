...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agenciado.talle_ropa_camisa'
        db.add_column(u'agencia_agenciado', 'talle_ropa_camisa',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='camisa', null=True, on_delete=models.PROTECT, to=orm['perfil.TalleRopa']),
                      keep_default=False)

        # Adding field 'Agenciado.talle_ropa_pantalon'
        db.add_column(u'agencia_agenciado', 'talle_ropa_pantalon',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='pantalon', null=True, on_delete=models.PROTECT, to=orm['perfil.TalleRopa']),
                      keep_default=False)

        # Deleting field 'Agencia.foto_agenciado_obligatoria'
        db.delete_column(u'agencia_agencia', 'foto_agenciado_obligatoria')


    def backwards(self, orm):
        # Deleting field 'Agenciado.talle_ropa_camisa'
        db.delete_column(u'agencia_agenciado', 'talle_ropa_camisa_id')

        # Deleting field 'Agenciado.talle_ropa_pantalon'
        db.delete_column(u'agencia_agenciado', 'talle_ropa_pantalon_id')

        # Adding field 'Agencia.foto_agenciado_obligatoria'
        db.add_column(u'agencia_agencia', 'foto_agenciado_obligatoria',
    ...
    models = {
        ...
        u'agencia.agenciado': {
            ...
            'fecha_ingreso': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 0, 0)'}),
            ...
            'talle_ropa_camisa': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'camisa'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['perfil.TalleRopa']"}),
            'talle_ropa_pantalon': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pantalon'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': u"orm['perfil.TalleRopa']"}),
