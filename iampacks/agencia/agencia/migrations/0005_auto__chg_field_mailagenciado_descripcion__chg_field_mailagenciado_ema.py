...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailAgenciado.descripcion'
        db.alter_column(u'agencia_mailagenciado', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'MailAgenciado.email'
        db.alter_column(u'agencia_mailagenciado', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75))

    def backwards(self, orm):

        # Changing field 'MailAgenciado.descripcion'
        db.alter_column(u'agencia_mailagenciado', 'descripcion', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'MailAgenciado.email'
        db.alter_column(u'agencia_mailagenciado', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))
    ...
    models = {
        ...
        u'agencia.agenciado': {
            ...
            'fecha_ingreso': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 5, 0, 0)'}),
