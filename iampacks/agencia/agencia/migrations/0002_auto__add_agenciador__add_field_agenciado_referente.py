...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Agenciador'
        db.create_table(u'agencia_agenciador', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'agencia', ['Agenciador'])

        # Adding field 'Agenciado.referente'
        db.add_column(u'agencia_agenciado', 'referente',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['agencia.Agenciador'], unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Agenciador'
        db.delete_table(u'agencia_agenciador')

        # Deleting field 'Agenciado.referente'
        db.delete_column(u'agencia_agenciado', 'referente_id')
