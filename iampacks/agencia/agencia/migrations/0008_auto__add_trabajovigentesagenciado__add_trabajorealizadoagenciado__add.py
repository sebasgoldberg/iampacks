...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrabajoVigentesAgenciado'
        db.create_table(u'agencia_trabajovigentesagenciado', (
        ...
        db.send_create_signal(u'agencia', ['TrabajoVigentesAgenciado'])

        # Adding model 'TrabajoRealizadoAgenciado'
        db.create_table(u'agencia_trabajorealizadoagenciado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('descripcion', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('fecha_desde', self.gf('django.db.models.fields.DateField')()),
            ('fecha_hasta', self.gf('django.db.models.fields.DateField')()),
            ('agenciado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencia.Agenciado'])),
        ))
        db.send_create_signal(u'agencia', ['TrabajoRealizadoAgenciado'])

        # Adding model 'DisponibilidadTrabajoAgenciado'
        db.create_table(u'agencia_disponibilidadtrabajoagenciado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dia_desde', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('dia_hasta', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('hora_desde', self.gf('django.db.models.fields.TimeField')()),
            ('hora_hasta', self.gf('django.db.models.fields.TimeField')()),
            ('agenciado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencia.Agenciado'])),
        ))
        db.send_create_signal(u'agencia', ['DisponibilidadTrabajoAgenciado'])

        # Adding field 'Agenciado.nombre_artistico'
        db.add_column(u'agencia_agenciado', 'nombre_artistico',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Agenciado.documento_drt'
        db.add_column(u'agencia_agenciado', 'documento_drt',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TrabajoVigentesAgenciado'
        db.delete_table(u'agencia_trabajovigentesagenciado')

        # Deleting model 'TrabajoRealizadoAgenciado'
        db.delete_table(u'agencia_trabajorealizadoagenciado')

        # Deleting model 'DisponibilidadTrabajoAgenciado'
        db.delete_table(u'agencia_disponibilidadtrabajoagenciado')

        # Deleting field 'Agenciado.nombre_artistico'
        db.delete_column(u'agencia_agenciado', 'nombre_artistico')

        # Deleting field 'Agenciado.documento_drt'
        db.delete_column(u'agencia_agenciado', 'documento_drt')
    ...
    models = {
        ...
        u'agencia.disponibilidadtrabajoagenciado': {
            ...
            'agenciado': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['agencia.Agenciado']"}),
            'dia_desde': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'dia_hasta': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
        ...
        u'agencia.trabajovigentesagenciado': {
            'Meta': {'object_name': 'TrabajoVigentesAgenciado'},
            'agenciado': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['agencia.Agenciado']"}),
            'descripcion': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
