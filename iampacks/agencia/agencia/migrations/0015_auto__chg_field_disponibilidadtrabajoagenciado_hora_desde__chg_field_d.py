...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DisponibilidadTrabajoAgenciado.hora_desde'
        db.alter_column(u'agencia_disponibilidadtrabajoagenciado', 'hora_desde', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'DisponibilidadTrabajoAgenciado.hora_hasta'
        db.alter_column(u'agencia_disponibilidadtrabajoagenciado', 'hora_hasta', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'DisponibilidadTrabajoAgenciado.hora_desde'
        db.alter_column(u'agencia_disponibilidadtrabajoagenciado', 'hora_desde', self.gf('django.db.models.fields.TimeField')(default=None))

        # Changing field 'DisponibilidadTrabajoAgenciado.hora_hasta'
        db.alter_column(u'agencia_disponibilidadtrabajoagenciado', 'hora_hasta', self.gf('django.db.models.fields.TimeField')(default=None))
    ...
    models = {
        ...
        u'agencia.agenciado': {
            ...
            'fecha_ingreso': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 31, 0, 0)'}),
