...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DisponibilidadTrabajoAgenciado.dia_desde'
        db.add_column(u'agencia_disponibilidadtrabajoagenciado', 'dia_desde',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=2),
                      keep_default=False)

        # Adding field 'DisponibilidadTrabajoAgenciado.dia_hasta'
        db.add_column(u'agencia_disponibilidadtrabajoagenciado', 'dia_hasta',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DisponibilidadTrabajoAgenciado.dia_desde'
        db.delete_column(u'agencia_disponibilidadtrabajoagenciado', 'dia_desde')

        # Deleting field 'DisponibilidadTrabajoAgenciado.dia_hasta'
        db.delete_column(u'agencia_disponibilidadtrabajoagenciado', 'dia_hasta')
