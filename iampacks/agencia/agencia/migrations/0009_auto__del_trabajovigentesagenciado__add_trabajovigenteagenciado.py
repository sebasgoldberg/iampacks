...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TrabajoVigenteAgenciado'
        db.create_table(u'agencia_trabajovigenteagenciado', (
        ...
        db.send_create_signal(u'agencia', ['TrabajoVigenteAgenciado'])


    def backwards(self, orm):
        # Adding model 'TrabajoVigentesAgenciado'
        db.create_table(u'agencia_trabajovigentesagenciado', (
            ('descripcion', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True)),
            ('fecha_vigencia', self.gf('django.db.models.fields.DateField')()),
            ('agenciado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agencia.Agenciado'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        ...
        # Deleting model 'TrabajoVigenteAgenciado'
        db.delete_table(u'agencia_trabajovigenteagenciado')
