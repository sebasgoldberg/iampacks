...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Agenciado.nombre_completo'
        db.add_column(u'agencia_agenciado', 'nombre_completo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=121),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Agenciado.nombre_completo'
        db.delete_column(u'agencia_agenciado', 'nombre_completo')
